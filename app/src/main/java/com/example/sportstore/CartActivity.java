...
import com.example.sportstore.Model.Cart;
import com.example.sportstore.Model.Products;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    if(shippingState.equals("shipped"))
                    {
                        ...
                        Toast.makeText(CartActivity.this, "You can purchase more products, once you recieve the previous final order!", Toast.LENGTH_SHORT).show();
                    }
